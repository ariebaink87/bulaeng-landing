...
export const FloatingDock: React.FC = () => {
  ...
  return (
    <aside className="fixed right-6 top-1/2 -translate-y-1/2 z-[9999] hidden lg:flex flex-col gap-3 pointer-events-auto">
      {navItems.map((item, index) => (
        <a
          ...
          className="w-[60px] h-[60px] rounded-[20px] bg-[#131F3A]/90 border border-[#D4AF37]/30 flex items-center justify-center text-xl backdrop-blur-md transition-all duration-300 hover:scale-110 hover:border-[#D4AF37] hover:bg-[#1c2c52] glow-gold-premium-hover group relative cursor-pointer z-[10000]"
        >
          <span>{item.icon}</span>
